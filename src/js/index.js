...
import { initLanguage } from './translation.js'; // путь подправь под свою структуру
...
const loadVideoTexture = (src) => {
	return new Promise((resolve, reject) => {
		...
		// Сначала ждём метаданные — тут videoWidth/videoHeight уже точно есть
		video.addEventListener('loadedmetadata', () => {
			...
			// Потом ждём готовности к воспроизведению и резолвим
...
document.addEventListener("click", (e) => {
	if (e.target.closest('#player-container')) return; // ← добавить
