...
$(function () {
	...
	const albums = ["Sergey Martin", "Sergey Martin"];
	const trackNames = ["Soulcraft #1", "Soulcraft #2"];
	const albumArtworks = ["_1", "_2"];
	const trackUrl = [track1, track2];
	...
	let audio,
		...
		tFlag = false,
		currIndex = -1,
		currAlbum,         // <--- добавь это
		currTrackName,     // <--- добавь это
		currArtwork;
